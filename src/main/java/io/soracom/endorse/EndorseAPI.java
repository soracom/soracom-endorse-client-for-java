...
public class EndorseAPI {
	 ...
	 * @throws Exception
	 */
	private static HttpResponse postKeyRequest(String url, String body, String timestamp, String algorithm, String signature) {
	 ...
	 */
	public static String requestService( String url, byte[] ck, long timestamp, String keyId, int keyLength,  String algorithm, String jsonParameters){
